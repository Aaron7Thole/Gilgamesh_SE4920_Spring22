            ...
            <form>
                <div className="container">
                    <div className='boxOne'>
                        ...
                        <div>
                            <p className='container-p'>Create an account to start finding a park fit for your four legged friend</p>
                        </div>
                    </div>
                    <div className='app-wrapper'>
                        <form className='app-login'>
                            <div className='app-Google'>
                                <button type="submit" className="btn-app" onClick={handelFormSubmit}>Sign In with Google</button>
                            </div>
                            <div className='app-Facebook'>
                                <button type="submit" className="btn-app" onClick={handelFormSubmit}>Sign In with Facebook</button>
                            </div>
                            <div className='app-Apple'>
                                <button type="submit" className="btn-app" onClick={handelFormSubmit}>Sign In with Apple</button>
                            </div>
                        </form>
